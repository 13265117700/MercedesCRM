...
<div class="content-mainer">
  ...
  <div class="form-section">
    ...
    <div class="form-item">
      ...
      <div class="form-item">
        <select id="clueStatus" class="form-input">
          <option value="0"{% if clue.status == 0 %} selected {% endif %}>请选择线索状态</option>
    ...
    <div class="form-item">
      ...
      <textarea id="clueRemark" class="form-textarea" placeholder="备注信息" onfocus="this.placeholder=''" onblur="this.placeholder='备注信息'">{{clue.remark}}</textarea>
    </div>
    <div class="form-item">
  ...
  <div class="log-section">
    ...
    <div class="form-section">
      <div class="form-item">
        ...
        <textarea id="logContent" class="form-textarea" placeholder="请输入本次跟踪的记录 ～" onfocus="this.placeholder=''" onblur="this.placeholder='请输入本次跟踪的记录 ～'"></textarea>
      </div>
      <div class="form-item">
